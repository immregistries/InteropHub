...
public class ApiAuthExchangeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.getWriter().write("{"
                ...
                + "\"name\":\"" + escapeJson(orEmpty(user.getFullName())) + "\","
                + "\"first_name\":"
                + (user.getFirstName() == null ? "null" : "\"" + escapeJson(user.getFirstName()) + "\"") + ","
                + "\"last_name\":"
                + (user.getLastName() == null ? "null" : "\"" + escapeJson(user.getLastName()) + "\"") + ","
