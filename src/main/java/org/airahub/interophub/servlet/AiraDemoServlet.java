...
public class AiraDemoServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
                ...
                try (PrintWriter out = response.getWriter()) {
                        ...
                        out.println("        <p>This is an unauthenticated AIRA Web integration demo. It does not require login, session state, or application data.</p>");
                        out.println("      </section>");
                        ...
                        out.println("            </div>");
                        out.println("            <div class=\"aira-card__footer aira-cluster\">");
                        out.println(
