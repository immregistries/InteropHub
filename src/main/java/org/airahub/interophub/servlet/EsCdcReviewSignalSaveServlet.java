...
public class EsCdcReviewSignalSaveServlet extends HttpServlet {
    ...
    public EsCdcReviewSignalSaveServlet() {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            EsTopicReviewService.SaveResult saveResult = reviewService.saveCdcSignal(
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.print(",\"reviewedCount\":" + saveResult.reviewedCount());
                out.print("}");
            }
