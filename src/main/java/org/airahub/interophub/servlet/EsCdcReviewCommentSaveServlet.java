...
public class EsCdcReviewCommentSaveServlet extends HttpServlet {

    private final AuthFlowService authFlowService;
    private final EsCampaignDao campaignDao;
    private final EsTopicReviewService reviewService;

    public EsCdcReviewCommentSaveServlet() {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            EsComment comment = reviewService.addCdcTopicComment(campaign.get().getEsCampaignId(), topicId, user.get(),
                    commentText);
