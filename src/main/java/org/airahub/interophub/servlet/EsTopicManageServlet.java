...
public class EsTopicManageServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        boolean canManage = isAdmin || topicSubscriptions.stream().anyMatch(s -> isChampionEquivalentStatus(s.getStatus())
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("  <title>Manage " + escapeHtml(orEmpty(topic.getTopicName())) + " - InteropHub</title>");
            ...
            for (EsTopicCuration entry : curatedEntries) {
                ...
                if (isEditing) {
                    ...
                    out.println("                  <div><label style='font-size:0.82rem; font-weight:600; color:#5b6673;"
                            ...
                            + " value='" + (entry.getDisplayOrder() == null ? 0 : entry.getDisplayOrder()) + "'"
                    ...
                    out.println("                  <div><label style='font-size:0.82rem; font-weight:600; color:#5b6673;"
                            ...
                            + " value='" + (entry.getAgendaCadenceDays() == null ? "" : entry.getAgendaCadenceDays())
                            + "'"
                            + " min='0' style='font-size:0.87rem; padding:0.3rem 0.5rem; border:1px solid #d5dde5;'"
